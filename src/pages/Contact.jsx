...
// Updated color palette to match About page
const PINK = '#B2278C';
...
export default function Contact() {
  ...
  return (
    <div style={{ background: WHITE }}>
      ...
      {/* Hero Section with Pink Gradient to match About */}
      <section style={{
        minHeight: '40vh',
        display: 'flex',
        alignItems: 'center',
        ...
        <div style={{ 
          ...
          borderRadius: '50%', 
          background: `radial-gradient(circle, ${PINK_MID} 0%, transparent 70%)`, 
          bottom: '5%', 
          left: '-5%', 
          pointerEvents: 'none' 
        }} />
