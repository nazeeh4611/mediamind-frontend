...
export const scrollingServices = [
  {
    ...
    bg: 'linear-gradient(135deg,#a8edea,#5de0e6)',
    accent: '#0d9488',
    img: '/seo.avif',
    color: '#0d9488',
  ...
  },
  {
    tag: 'Pay Per Click',
    title: 'Find Leads\nWhich Convert',
    desc: 'Unlock the full potential of Paid Search with data, AI, and smart creative thinking. Our PPC services ensure we drive sales, generate leads, & increase your brand awareness.',
