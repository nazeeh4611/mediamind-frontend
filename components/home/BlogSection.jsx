    ...
    <section style={{ padding: '7rem 0', background: WHITE }}>
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 2rem' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '3.5rem', flexWrap: 'wrap', gap: '1rem' }}>
          ...
          <Link href="/blogs" style={{ fontFamily: "'Inter', sans-serif", fontWeight: 700, fontSize: '0.85rem', color: ORANGE, textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: '0.4rem' }}>
